...
import { DropdownMenu, DropdownMenuContent, DropdownMenuTrigger } from '@/components/editor/dropdown-menu';
    ...
    return (
        <ToolbarSplitButton pressed={open}>
            ...
            <DropdownMenu open={open} onOpenChange={setOpen} modal={false}>
                ...
                <DropdownMenuContent align="start" alignOffset={-32} className="bg-white"></DropdownMenuContent>
            </DropdownMenu>
        </ToolbarSplitButton>
    );
}
